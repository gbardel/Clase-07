...
namespace AgeToDays
{
    public partial class CalculateDays : System.Web.UI.Page
    {
        ...
        protected void btnCalcularAddDays_Click(object sender, EventArgs e)
        {
            ...
            // Consumir servicio web desde referencia de visual studio
            /*CalculateAgeInDays.appservicedaysASMX.DaysOperations daysOperations = new CalculateAgeInDays.appservicedaysASMX.DaysOperations();
        ...
        protected void btnSubstractAddDays_Click(object sender, EventArgs e)
        {
            ...
            // Consumir servicio web desde referencia de visual studio
            /*CalculateAgeInDays.appservicedaysASMX.DaysOperations daysOperations = new CalculateAgeInDays.appservicedaysASMX.DaysOperations();
            string days = daysOperations.SubtractDays(day,month,year,count);
            lblResultado1.Text = "Resultado: " + days.ToString();*/
