...
namespace WSDaysOperations {
    ...
    public partial class DaysOperations : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public DaysOperations() {
            this.Url = "http://appservicedays.azurewebsites.net/DaysOperations.asmx";
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginConvertToDays(int day, int month, int year, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("ConvertToDays", new object[] {
                        day,
                        month,
        ...
        /// <remarks/>
        public int EndConvertToDays(System.IAsyncResult asyncResult) {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginDaysBetweenDates(int day1, int month1, int year1, int day2, int month2, int year2, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("DaysBetweenDates", new object[] {
                        day1,
                        month1,
                        year1,
                        day2,
                        month2,
                        year2}, callback, asyncState);
        }
        
        /// <remarks/>
        public int EndDaysBetweenDates(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((int)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginAddDays(int day, int month, int year, int days, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("AddDays", new object[] {
                        day,
                        month,
                        year,
        ...
        /// <remarks/>
        public string EndAddDays(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((string)(results[0]));
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginSubtractDays(int day, int month, int year, int days, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("SubtractDays", new object[] {
                        day,
                        month,
                        year,
                        days}, callback, asyncState);
        ...
        /// <remarks/>
        public string EndSubtractDays(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((string)(results[0]));
        }
